<template>
    <footer class="bg-black py-14">
         <div class="container flex gap-24">
            <div class="max-w-[320px]">
                <p class="font-bold text-xl text-white">Copyright 2020</p>
                <p class="font-normal text-base text-white mt-4">Nullam laoreet nec turpis et ultrices. Duis sit amet quam arcu. Nam facilisis lacinia ex, eget sollicitudin massa pellentesque in. Vivamus mattis eros at sem pulvinar tincidunt.</p>
            </div>
            <div>
                <p class="font-bold text-xl text-white">Sayt sahifalari</p>
                <ul class="mt-4">
                    <li class="font-normal text-base text-white">
                        <RouterLink to="/menu">Bosh sahifa</RouterLink>
                    </li>
                    <li class="font-normal text-base text-white my-2">
                        <RouterLink to="/sevice">Xizmatlar</RouterLink>
                    </li>
                    <li class="font-normal text-base text-white">
                        <RouterLink to="/portfolio">Portfolio</RouterLink>
                    </li>
                    <li class="font-normal text-base text-white my-2">
                        <RouterLink to="/team">Jamoa</RouterLink>
                    </li>
                    <li class="font-normal text-base text-white">
                        <RouterLink to="/blog">Blog</RouterLink>
                    </li>
                    <li class="font-normal text-base text-white mt-2">
                        <RouterLink to="/contacts">Kontaktlar</RouterLink>
                    </li>
                </ul>
            </div>
            <div>
                <p class="font-bold text-xl text-white">Biz internetda</p>
                <ul class="mt-4">
                    <li>
                        <a href="#" class="flex gap-2 text-white items-center font-normal">
                            <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14_1998)">
<path d="M11 0.375C4.92339 0.375 0 5.57812 0 12C0 18.4219 4.92339 23.625 11 23.625C17.0766 23.625 22 18.4219 22 12C22 5.57812 17.0766 0.375 11 0.375ZM16.4024 8.33906L14.5972 17.3297C14.4641 17.9672 14.1048 18.1219 13.6036 17.8219L10.8536 15.6797L9.52742 17.0297C9.38105 17.1844 9.25686 17.3156 8.97298 17.3156L9.16815 14.3578L14.2645 9.49219C14.4863 9.28594 14.2157 9.16875 13.923 9.375L7.6246 13.5656L4.91008 12.6703C4.32016 12.4734 4.30685 12.0469 5.03427 11.7469L15.6395 7.425C16.1319 7.2375 16.5621 7.55156 16.4024 8.33906Z" fill="white"/>
</g>
<defs>
